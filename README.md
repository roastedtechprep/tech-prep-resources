# Tech Interview Preperation Resources
...
* [Facebook's Hardware Infrastructure Management](https://engineering.fb.com/2020/12/09/data-center-engineering/how-facebook-keeps-its-large-scale-infrastructure-hardware-up-and-running/)
* [Meta's Global Capacity Management](https://engineering.fb.com/2022/09/06/data-center-engineering/viewing-the-world-as-a-computer-global-capacity-management/)
...
* [Ceph's Open-Source File Distribution](https://docs.ceph.com/en/latest/architecture/)
...
* [Pinterest Time Series DB - Goku](https://medium.com/pinterest-engineering/goku-building-a-scalable-and-high-performant-time-series-database-system-a8ff5758a181)
* [Relational Time Series DB](https://www.timescale.com/blog/time-series-data-why-and-how-to-use-a-relational-database-instead-of-nosql-d0cd6975e87c/)
* [Facebook's Time Series DB - Gorilla](http://www.vldb.org/pvldb/vol8/p1816-teller.pdf)
...
* [Message Queing](https://www.cloudamqp.com/blog/what-is-message-queuing.html)
* [Whatsapp System Architecture](https://medium.com/interviewnoodle/whatsapp-system-architecture-8df0250d572f)
* [Understanding Whatsapp Architecture](https://hackernoon.com/understanding-whatsapp-architecture?source=rss)
* [Facebook's Messenger Optimisation](https://spectrum.ieee.org/how-facebooks-software-engineers-prepare-messenger-for-new-years-eve)

## Message Queue AntiPattern
* [Database is not a Queue](http://blog.codepath.com/2012/11/15/asynchronous-processing-in-web-applications-part-1-a-database-is-not-a-queue/)
* [Why DB as Queue is Bad](https://softwareengineering.stackexchange.com/questions/231410/why-database-as-queue-so-bad)
* [DB as Queue Anti Pattern](http://mikehadlow.blogspot.com/2012/04/database-as-queue-anti-pattern.html)
* [DB is not the right tool to use a Queue based System](https://www.cloudamqp.com/blog/why-is-a-database-not-the-right-tool-for-a-queue-based-system.html)

## Video Processing
* [Facebook's Live Broadcasting](https://engineering.fb.com/2015/12/03/ios/under-the-hood-broadcasting-live-video-to-millions/)
* [Transcoding: Serving Videos at Scale](https://www.egnyte.com/blog/post/transcoding-how-we-serve-videos-at-scale/)
* [Netflix's HQ Video Encoding at Scale](https://netflixtechblog.com/high-quality-video-encoding-at-scale-d159db052746)
* [Netflix's Shot-based Video Encoding](https://netflixtechblog.com/optimized-shot-based-encodes-now-streaming-4b9464204830)
* [Youtube's Scalability](https://www.youtube.com/watch?v=w5WVu624fY8)

## Rate Limiting
* [Circuit Breaker Algorithm by Martin Fowler](https://martinfowler.com/bliki/CircuitBreaker.html)
* [Uber Rate Limiter](https://github.com/uber-go/ratelimit/blob/main/ratelimit.go)
